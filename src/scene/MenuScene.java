...
public class MenuScene extends Scene {
	...
	public void generateOutput(Graphics g) {
		...
		int playerImgWidth = mPlayerImg.getWidth() * 3;
		int playerImgHeight = mPlayerImg.getHeight() * 3;
		x = (windowWidth - playerImgWidth) / 2;
		y += (int) (Grid.TILE_SIZE);
		g.drawImage(mPlayerImg, x, y, playerImgWidth, playerImgHeight, null);
